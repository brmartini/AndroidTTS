package com.fiap.mob.androidtts;
...
public class MainActivity extends AppCompatActivity implements OnClickListener,TextToSpeech.OnInitListener {
    private Button btnFalar, btnEscutar;
    private EditText edtTxt;
    private TextView txvTranscricao;
    //Objeto TTS
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnEscutar = (Button) findViewById(R.id.btnEscutar);
        txvTranscricao = (TextView) findViewById(R.id.txvTranscricao);
    ...
    public void onClick(View v) {
        ...
        if(v.getId() == R.id.btnFalar){
            ...
            falar(edtTxt.getText().toString());
        }
        if(v.getId() == R.id.btnEscutar){
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == REQUEST_TTS) {
            ...
            if (resultCode == RESULT_OK && null != data) {
                ...
                txvTranscricao.setText(result.get(0));
            }
